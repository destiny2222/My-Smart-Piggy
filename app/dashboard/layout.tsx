  ...
  return (
    <ProtectedRoute>
      ...
      >
        ...
        {/* Navigation */}
        <nav className="py-3 px-3 space-y-1 flex-1 overflow-y-auto">
          {navItems.map((item) => {
        ...
        {/* Bottom Navigation */}
        <div className="border-t border-gray-200 bg-[#f5f6fa] py-3 px-3 space-y-1 mt-auto">
          ...
          <button
            ...
            className="flex items-center gap-3 px-3 py-2 rounded-lg text-sm transition text-gray-600 hover:bg-red-50 hover:text-red-600 font-medium w-full text-left"
          >
            <LogOut size={18} />
            Logout
          </button>
